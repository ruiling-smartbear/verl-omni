# Lance LoRA RL (text-to-video), vllm_omni rollout (FlowGRPO) with an ImageBind reward
#
...
#
# Prerequisite: the PickScore prompts plus the Lance bundle, as for the t2i recipe.
...
python3 -m verl_omni.trainer.main_diffusion \
    ...
    trainer.experiment_name=lance_t2v_imagebind_lora \
